...
if($_SESSION['username'] != null)
{
	...
	$sql = "SELECT * FROM retailer_table where username = '$username' ";
        $result = mysql_query($sql);
        $row = mysql_fetch_row($result);
	
        echo "<form style='width:980px;margin: auto;' name=\"form\" method=\"post\" action=\"retailer_select_finish.php\">";
		echo "<div style='margin-left:390px;margin-top:100px;	font-size:30px;letter-spacing: normal;font-weight:900;color: #1F7CFF;'>經銷商資料查詢 </div>";
        ...
        echo "<p style='position:absolute;margin-left:240px;margin-top:15px;'>名稱</p>
        ...
        echo "<p style='position:absolute;margin-left:240px;margin-top:15px;'>電話</p>
